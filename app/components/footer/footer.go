				...
				container.New(
					center.New(
						container.New(
							...
							container.ContainerStyle(appTheme.Data().BoxTheme.ContainerStyle.Tertiary),
					...
					[]application.BaseWidget{
						...
						row.New(
							[]application.BaseWidget{
								...
								text.New("•", text.TextStyle(appTheme.Data().TextTheme.TextStyle.Tertiary), text.FontSize(14)),
